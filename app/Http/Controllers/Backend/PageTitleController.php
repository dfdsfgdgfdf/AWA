...
class PageTitleController extends Controller
{
    ...
    public function store(PageTitleRequest $request)
    {
        ...
        return redirect()->route('admin.page-titles.index')->with([
            'message' => 'PageTitle Created Successfully',
            'alert-type' => 'success'
        ]);
    }
    ...
    public function update(PageTitleRequest $request, PageTitle $pageTitle)
    {
        ...
        return redirect()->route('admin.page-titles.index')->with([
            'message' => 'PageTitle Updated Successfully',
            'alert-type' => 'success'
        ]);
    }
    ...
    public function destroy(PageTitle $pageTitle)
    {
        ...
        return redirect()->route('admin.page-titles.index')->with([
            'message' => 'PageTitle Deleted Successfully',
            'alert-type' => 'success'
        ]);
