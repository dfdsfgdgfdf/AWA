                ...
                <li
                    ...
                    @if ($menu->appearedChildren !== null && count($menu->appearedChildren) > 0)
                        <div id="collapse_{{ $menu->route }}"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                @foreach ($menu->appearedChildren as $sub_menu)
                                    <a class="collapse-item {{ getParentOf($current_page) != null && (int) (getParentIdOf($current_page)) == $sub_menu->id? 'active': null }}"
                                        href="{{ route('admin.' . $sub_menu->as) }}">
                                        <i class="{{ $sub_menu->icon != null ? $sub_menu->icon : 'fa fa-home' }}"></i>
                                        {{ $sub_menu->display_name }}
                                    </a>
                                @endforeach
                            </div>
