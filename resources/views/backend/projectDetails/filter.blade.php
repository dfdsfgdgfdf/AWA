<div class="card-body">
    <form action="{{ route('admin.our-work.projectDetails.index') }}" method="get">
        <div class="row">
            <div class="col-2">
            ...
            <div class="col-2">
                <div class="form-group">
                    <select name="top" class="form-control">
                        ...
                        <option value="1" {{ old('top', request()->input('top')) == '1' ? 'selected' : '' }}>Top</option>
                        <option value="0" {{ old('top', request()->input('top')) == '0' ? 'selected' : ''  }}>Normal</option>
                    </select>
                </div>
            </div>
            <div class="col-2">
