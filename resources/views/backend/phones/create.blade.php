...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Create Phone</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.phones.store') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <select name="type" class="form-control">
                            <option value="WhatsApp" {{ old('type') == "WhatsApp" ? 'selected' : null }}>WhatsApp</option>
                ...
                <div class="form-group pt-4">
                    <button type="submit" name="submit" class="btn btn-primary">Add Phone</button>
                </div>
            </form>
        </div>
    </div>
