        ...
        <table class="table table-hover">
            ...
            @forelse($admins as $admin)
                <tr>
                    <td>
                        @if ($admin->user_image != '')
                            <img class="rounded-circle" src="{{ asset('assets/admins/' . $admin->user_image) }}" width="60" height="60" alt="{{ $admin->full_name }}">
                        @else
                            <img src="{{ asset('assets/admins/avatar.png') }}" width="60">
                        @endif
                    </td>
                    <td>
